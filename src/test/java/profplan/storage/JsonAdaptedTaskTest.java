...
public class JsonAdaptedTaskTest {
    ...
    public void toModelType_invalidName_throwsIllegalValueException() {
        JsonAdaptedTask task =
                new JsonAdaptedTask(INVALID_NAME, VALID_PRIORITY, VALID_EMAIL,
                                    VALID_ADDRESS, "undone", VALID_TAGS, VALID_DUEDATE, VALID_CHILDREN);
    ...
    public void toModelType_invalidAddress_throwsIllegalValueException() {
        JsonAdaptedTask task =
                new JsonAdaptedTask(VALID_NAME, VALID_PRIORITY, VALID_EMAIL, INVALID_ADDRESS, "undone",
                                    VALID_TAGS, VALID_DUEDATE, VALID_CHILDREN);
    ...
    public void toModelType_nullAddress_throwsIllegalValueException() {
        JsonAdaptedTask task = new JsonAdaptedTask(VALID_NAME, VALID_PRIORITY, VALID_EMAIL,
            null, "undone", VALID_TAGS, VALID_DUEDATE, VALID_CHILDREN);
    ...
    public void toModelType_invalidTags_throwsIllegalValueException() {
        ...
        JsonAdaptedTask task =
                new JsonAdaptedTask(VALID_NAME, VALID_PRIORITY, VALID_EMAIL, VALID_ADDRESS, "undone",
                                    invalidTags, VALID_DUEDATE, VALID_CHILDREN);
