...
public class CommandTestUtil {
    ...
    public static final String DESCRIPTION_DESC_AMY = VALID_DESCRIPTION;
    public static final String DESCRIPTION_DESC_BOB = VALID_DESCRIPTION;
    ...
    static {
        DESC_AMY = new EditTaskDescriptorBuilder().withName(VALID_NAME_AMY)
                .withPriority(VALID_PRIORITY_AMY).withEmail(VALID_EMAIL_AMY)
                .withTags(VALID_TAG_FRIEND).build();
        DESC_BOB = new EditTaskDescriptorBuilder().withName(VALID_NAME_BOB)
                .withPriority(VALID_PRIORITY_BOB).withEmail(VALID_EMAIL_BOB)
